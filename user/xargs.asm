...
int main(int argc, char **argv){
  ...
  1a:	8aae                	mv	s5,a1
    ...
    if(argc < 2){
  1c:	4785                	li	a5,1
  1e:	06a7db63          	bge	a5,a0,94 <main+0x94>
        fprintf(2, " too less arg (eg. echo a.txt | xargs grep name)");
    }
    char **str = (char **)malloc(sizeof(char *) * MAXARG);
  22:	10000513          	li	a0,256
  26:	00000097          	auipc	ra,0x0
  2a:	7fc080e7          	jalr	2044(ra) # 822 <malloc>
  2e:	8a2a                	mv	s4,a0
    for(int i = 0 ; i < MAXARG; i++){
  30:	892a                	mv	s2,a0
  32:	10050993          	addi	s3,a0,256
    char **str = (char **)malloc(sizeof(char *) * MAXARG);
  36:	84aa                	mv	s1,a0
        str[i] = (char *)malloc(sizeof(char) * MAXPATH);
  38:	08000513          	li	a0,128
  3c:	00000097          	auipc	ra,0x0
  40:	7e6080e7          	jalr	2022(ra) # 822 <malloc>
  44:	e088                	sd	a0,0(s1)
    for(int i = 0 ; i < MAXARG; i++){
  46:	04a1                	addi	s1,s1,8
  48:	ff3498e3          	bne	s1,s3,38 <main+0x38>
    }
    for(; index < argc - 1; index++){
  4c:	4785                	li	a5,1
  4e:	0577dd63          	bge	a5,s7,a8 <main+0xa8>
  52:	008a8b13          	addi	s6,s5,8
  56:	000b899b          	sext.w	s3,s7
  5a:	3bf9                	addiw	s7,s7,-2
  5c:	1b82                	slli	s7,s7,0x20
  5e:	020bdb93          	srli	s7,s7,0x20
  62:	0b85                	addi	s7,s7,1
  64:	0b8e                	slli	s7,s7,0x3
  66:	9bd2                	add	s7,s7,s4
  68:	84d2                	mv	s1,s4
        strcpy(str[index], argv[index + 1]);
  6a:	000b3583          	ld	a1,0(s6)
  6e:	6088                	ld	a0,0(s1)
  70:	00000097          	auipc	ra,0x0
  74:	106080e7          	jalr	262(ra) # 176 <strcpy>
    for(; index < argc - 1; index++){
  78:	04a1                	addi	s1,s1,8
  7a:	0b21                	addi	s6,s6,8
  7c:	ff7497e3          	bne	s1,s7,6a <main+0x6a>
  80:	39fd                	addiw	s3,s3,-1
    }
    //printf("%d",sizeof(str));
    int n = 0;
  82:	4481                	li	s1,0
  ...
  84:	4b29                	li	s6,10
        ...
        if(n > MAXPATH)
  86:	08000b93          	li	s7,128
            fprintf(2, "too long arg!");
  8a:	00001c17          	auipc	s8,0x1
  8e:	8bec0c13          	addi	s8,s8,-1858 # 948 <malloc+0x126>
  92:	a815                	j	c6 <main+0xc6>
        fprintf(2, " too less arg (eg. echo a.txt | xargs grep name)");
  94:	00001597          	auipc	a1,0x1
  98:	87c58593          	addi	a1,a1,-1924 # 910 <malloc+0xee>
  9c:	4509                	li	a0,2
  9e:	00000097          	auipc	ra,0x0
  a2:	698080e7          	jalr	1688(ra) # 736 <fprintf>
  a6:	bfb5                	j	22 <main+0x22>
    int index = 0;
  a8:	4981                	li	s3,0
  aa:	bfe1                	j	82 <main+0x82>
            index++;
  ac:	2985                	addiw	s3,s3,1
            n = 0;
  ae:	4481                	li	s1,0
            continue;
  b0:	a819                	j	c6 <main+0xc6>
        str[index][n++] = c;
  b2:	faf44703          	lbu	a4,-81(s0)
  b6:	00399793          	slli	a5,s3,0x3
  ba:	97d2                	add	a5,a5,s4
  bc:	639c                	ld	a5,0(a5)
  ...
  c4:	2485                	addiw	s1,s1,1
    while(read(0, &c, 1) > 0){
  c6:	4605                	li	a2,1
  c8:	faf40593          	addi	a1,s0,-81
  cc:	4501                	li	a0,0
  ce:	00000097          	auipc	ra,0x0
  d2:	336080e7          	jalr	822(ra) # 404 <read>
  d6:	00a05f63          	blez	a0,f4 <main+0xf4>
        if(c == '\n'){
  da:	faf44783          	lbu	a5,-81(s0)
  de:	fd6787e3          	beq	a5,s6,ac <main+0xac>
        if(n > MAXPATH)
  e2:	fc9bd8e3          	bge	s7,s1,b2 <main+0xb2>
            fprintf(2, "too long arg!");
  e6:	85e2                	mv	a1,s8
  e8:	4509                	li	a0,2
  ea:	00000097          	auipc	ra,0x0
  ee:	64c080e7          	jalr	1612(ra) # 736 <fprintf>
  f2:	b7c1                	j	b2 <main+0xb2>
    }
    for(int i = 0; i < index; i++){
  f4:	03305163          	blez	s3,116 <main+0x116>
  f8:	87d6                	mv	a5,s5
  fa:	fff9871b          	addiw	a4,s3,-1
  fe:	1702                	slli	a4,a4,0x20
 100:	9301                	srli	a4,a4,0x20
 102:	070e                	slli	a4,a4,0x3
 104:	0a21                	addi	s4,s4,8
 106:	9a3a                	add	s4,s4,a4
        argv[i] = str[i];
 108:	00093703          	ld	a4,0(s2)
 10c:	e398                	sd	a4,0(a5)
    for(int i = 0; i < index; i++){
 10e:	0921                	addi	s2,s2,8
 110:	07a1                	addi	a5,a5,8
 112:	ff491be3          	bne	s2,s4,108 <main+0x108>
    }
    argv[index] = 0;
 116:	098e                	slli	s3,s3,0x3
 118:	99d6                	add	s3,s3,s5
 11a:	0009b023          	sd	zero,0(s3)
    exec(argv[0], argv);
 11e:	85d6                	mv	a1,s5
 120:	000ab503          	ld	a0,0(s5)
 124:	00000097          	auipc	ra,0x0
 128:	300080e7          	jalr	768(ra) # 424 <exec>
    fprintf(2, "exec %s failed\n", argv[0]);
 12c:	000ab603          	ld	a2,0(s5)
 130:	00001597          	auipc	a1,0x1
 134:	82858593          	addi	a1,a1,-2008 # 958 <malloc+0x136>
 138:	4509                	li	a0,2
 13a:	00000097          	auipc	ra,0x0
 13e:	5fc080e7          	jalr	1532(ra) # 736 <fprintf>
...
_main()
{
 ...
 168:	e9c080e7          	jalr	-356(ra) # 0 <main>
  exit(0);
 16c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4d4:	4a050513          	addi	a0,a0,1184 # 970 <digits>
 4d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5a0:	3d4b8b93          	addi	s7,s7,980 # 970 <digits>
 ...
 6e0:	28c90913          	addi	s2,s2,652 # 968 <malloc+0x146>
        while(*s != 0){
