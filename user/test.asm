...
void func1(){
   ...
   c:	80858593          	addi	a1,a1,-2040 # 810 <malloc+0xe8>
  10:	4505                	li	a0,1
  12:	00000097          	auipc	ra,0x0
  16:	62a080e7          	jalr	1578(ra) # 63c <fprintf>
    fprintf(1, "i = %d\n", i);
  1a:	4609                	li	a2,2
  1c:	00001597          	auipc	a1,0x1
  20:	80458593          	addi	a1,a1,-2044 # 820 <malloc+0xf8>
  24:	4505                	li	a0,1
  26:	00000097          	auipc	ra,0x0
  2a:	616080e7          	jalr	1558(ra) # 63c <fprintf>
    return;
}
  2e:	60a2                	ld	ra,8(sp)
  30:	6402                	ld	s0,0(sp)
...
int main(int argc, char *argv[]){
  ...
  42:	7ea58593          	addi	a1,a1,2026 # 828 <malloc+0x100>
  46:	4505                	li	a0,1
  48:	00000097          	auipc	ra,0x0
  4c:	5f4080e7          	jalr	1524(ra) # 63c <fprintf>
    func1();
  50:	00000097          	auipc	ra,0x0
  54:	fb0080e7          	jalr	-80(ra) # 0 <func1>
    return 0;
  58:	4501                	li	a0,0
  5a:	60a2                	ld	ra,8(sp)
  5c:	6402                	ld	s0,0(sp)
...
_main()
{
  ...
  6e:	fcc080e7          	jalr	-52(ra) # 36 <main>
  exit(0);
  72:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	46a50513          	addi	a0,a0,1130 # 840 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a6:	39eb8b93          	addi	s7,s7,926 # 840 <digits>
 ...
 5e6:	25690913          	addi	s2,s2,598 # 838 <malloc+0x110>
        while(*s != 0){
