...
int main(int argc, char *argv[]){
   ...
   e:	4581                	li	a1,0
  10:	00893503          	ld	a0,8(s2)
  14:	00000097          	auipc	ra,0x0
  18:	324080e7          	jalr	804(ra) # 338 <open>
  1c:	84aa                	mv	s1,a0
  1e:	02054963          	bltz	a0,50 <main+0x50>
        fprintf(2, "cannot open %s\n", argv[1]);
    }else{
        fprintf(1, "yes open %s\n", argv[1]);
  22:	00893603          	ld	a2,8(s2)
  26:	00001597          	auipc	a1,0x1
  2a:	80a58593          	addi	a1,a1,-2038 # 830 <malloc+0x102>
  2e:	4505                	li	a0,1
  30:	00000097          	auipc	ra,0x0
  34:	612080e7          	jalr	1554(ra) # 642 <fprintf>
    }
    close(fd);
  38:	8526                	mv	a0,s1
  3a:	00000097          	auipc	ra,0x0
  3e:	2e6080e7          	jalr	742(ra) # 320 <close>
    return 0;
  42:	4501                	li	a0,0
  44:	60e2                	ld	ra,24(sp)
  46:	6442                	ld	s0,16(sp)
  ...
  4e:	8082                	ret
        fprintf(2, "cannot open %s\n", argv[1]);
  50:	00893603          	ld	a2,8(s2)
  54:	00000597          	auipc	a1,0x0
  58:	7cc58593          	addi	a1,a1,1996 # 820 <malloc+0xf2>
  5c:	4509                	li	a0,2
  5e:	00000097          	auipc	ra,0x0
  62:	5e4080e7          	jalr	1508(ra) # 642 <fprintf>
  66:	bfc9                	j	38 <main+0x38>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e0:	46c50513          	addi	a0,a0,1132 # 848 <digits>
 3e4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ac:	3a0b8b93          	addi	s7,s7,928 # 848 <digits>
 ...
 5ec:	25890913          	addi	s2,s2,600 # 840 <malloc+0x112>
        while(*s != 0){
